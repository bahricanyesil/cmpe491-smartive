...
contract TravelTicket is ERC721, Pausable, Ownable {
    ...
    TravelDetails public travelDetails;
    mapping (uint256 => SeatBlock) public seatBlocks;
    uint256[] supplies;
    uint256[] seatBlockList;

    constructor(uint256 startDate_, string memory fromLocation_, string memory toLocation_, string memory transportType_, uint256 duration_) ERC721("TravelTicketToken", "TraT") {
